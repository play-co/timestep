...
exports.bind = function (context, method, ...boundArgs) {
  if (typeof method === 'function') {
    return method.bind(context, ...boundArgs);
  } else {
    return (...args) => context[method].apply(context, [...boundArgs, ...args]);
  }
};
 ...
 * @param {...Object} extra - Source objects.
 */
exports.merge = function (base) {
  base = base || {};
...
exports.fetchURL = (function (url, p = {}) {
  return axios.get(
    url, {
      params: p
    },
...
var _exportDeepCopy = exports.deepCopy;
var _exportFetchURL = exports.fetchURL;
...
export {
  ...
  _exportDeepCopy as deepCopy,
  _exportFetchURL as fetchURL,
