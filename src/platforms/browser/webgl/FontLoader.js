...
(function (root, definition) {
  ...
  var isIE = /MSIE/i.test(navigator.userAgent), ieVer = null;
  ...
  FontLoader.referenceFontFamilies = FontLoader.useAdobeBlank ? ['AdobeBlank'] : [
    'serif',
    'cursive'
  ];
  ...
  FontLoader.prototype = {
    ...
    loadFonts: function () {
      var self = this, newFontVariations;
    ...
    _loadAdobeBlankFont: function () {
      var self = this, adobeBlankDiv, adobeBlankFallbackFont = 'serif';
    ...
    _getNewFontVariationsFromFonts: function (fonts) {
      var font, key, i, variations = [], variationsMap = {};
    ...
    _convertShorthandToFontObjects: function (fontString) {
      var fonts = [], parts = fontString.split(':'), variants, fontFamily;
    ...
    _loadFonts: function () {
      var i, j, clonedDiv, sizeWatcher, font, fontKey, fontVariationKey, referenceFontSize, sizeWatcherDirection, sizeWatcherDimension, self = this;
  ...
  SizeWatcher.prototype = {
    ...
    prepareForWatch: function () {
      var parentNode, sizeDecreaseWatcherElmScrolled = true, sizeIncreaseWatcherElmScrolled = true;
