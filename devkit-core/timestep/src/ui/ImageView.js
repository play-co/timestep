...
export default class ImageView extends View {
  ...
  setImage (img, opts) {
    ...
    if (this._img) {
      ...
      this._img.doOnLoad(this, '_onLoad');
    }
  }

  _onLoad () {
    // This might be an old callback and we are now loading a different image
    // Avoid repaint in that case
  ...
  autoSize () {
    if (this._img) {
      ...
      if (this.style.fixedAspectRatio) {
        this.style.enforceAspectRatio(this.style._width, this.style._height);
      }
    }
  }
