 ...
 */
export default class BlendEngine extends View {
  constructor (opts) {
    opts = opts || {};
  ...
  obtainParticleArray (count) {
    ...
    // opts = opts || {};
    // count = opts.performanceScore && isMobile && !isSimulator ?
    //   0 : performance.getAdjustedParticleCount(count, opts.performanceScore, opts.allowReduction);
