...
export default class InputHandler {
  ...
  onLeave (id, atTarget, evt) {
    ...
    if (view.onInputOut) {
      view.onInputOut(over, this.overCount, atTarget, evt);
    }
    view.publish('InputOut', over, this.overCount, atTarget, evt);
  }
  resetOver () {
    delete this._over;
    this.overCount = 0;
...
InputHandler.prototype.startCount = 0;
InputHandler.prototype.dragCount = 0;
InputHandler.prototype.overCount = 0;
InputHandler.prototype.canHandleEvents = true;
InputHandler.prototype.blockEvents = false;
